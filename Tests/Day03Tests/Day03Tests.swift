...
struct Day03Tests {
    ...
    @Test func testMaxJoltageFromBank() {
        ...
        #expect(day.maxJoltageFromBank("987654321111111", selectCount: 2) == 98)

        // Test case 2: 811111111111119 -> 89 (8 and 9)
        #expect(day.maxJoltageFromBank("811111111111119", selectCount: 2) == 89)

        // Test case 3: 234234234234278 -> 78 (last two digits)
        #expect(day.maxJoltageFromBank("234234234234278", selectCount: 2) == 78)

        // Test case 4: 818181911112111 -> 92 (9 and the 2 after it)
        #expect(day.maxJoltageFromBank("818181911112111", selectCount: 2) == 92)
    }
    ...
    @Test func testSimpleCases() {
        ...
        // Simple ascending
        #expect(day.maxJoltageFromBank("12345", selectCount: 2) == 45)

        // Simple descending
        #expect(day.maxJoltageFromBank("54321", selectCount: 2) == 54)

        // Two digits
        #expect(day.maxJoltageFromBank("19", selectCount: 2) == 19)
        #expect(day.maxJoltageFromBank("91", selectCount: 2) == 91)

        // All same digits
        #expect(day.maxJoltageFromBank("11111", selectCount: 2) == 11)
        #expect(day.maxJoltageFromBank("99999", selectCount: 2) == 99)
    }
